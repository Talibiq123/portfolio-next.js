...
const Work = ( {isDarkMode} ) => {
  return (
    <motion.div initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{duration: 1}}
      id="projects"
      className=" min-h-screen w-full px-[12%] py-10 scroll-mt-20"
    >
      ...
      <motion.h2 initial={{y:-20, opacity: 0}} whileInView={{y:0, opacity: 1}} transition={{delay:0.3, duration: 1}} className=" text-4xl font-extrabold text-gray-800 text-center mb-12 dark:text-white">
        My Latest Work
      </motion.h2>
      ...
      <motion.div initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{delay:0.9, duration: 0.6}} className=" grid grid-cols-auto my-10 gap-5">
